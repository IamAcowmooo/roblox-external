...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    if (!(flags & ImGuiComboFlags_NoPreview)) {
        // Custom theme colors matching the dark menu theme
        ImVec4 topColor = ImVec4(0.082f, 0.082f, 0.082f, 1.0f); // #151515 - child background color
        ImVec4 bottomColor = ImVec4(0.110f, 0.110f, 0.110f, 1.0f); // #1C1C1C - main window background
        ...
        // Border color matching theme - using a subtle gray border
        ImVec4 borderColorVec = ImVec4(0.2f, 0.2f, 0.2f, 1.0f); // #333333 - subtle border
    ...
    {
        // Custom button colors matching theme
        ImU32 bg_col = (popup_open || hovered) ? IM_COL32(34, 34, 34, 255) : IM_COL32(25, 25, 25, 255); // #222222 if hovered/open, #191919 if normal
        ImU32 text_col;
        // White text to match theme
        text_col = IM_COL32(255, 255, 255, 255); // White text
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    const float slider_height = g.FontSize * 0.8f;
    ...
    float extra_width = (label_size.x > 0) ? -ImGui::CalcTextSize(value_buf).x : style.ItemInnerSpacing.x;
